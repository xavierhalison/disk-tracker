    ...
    <div className="bg-ink-black-900 min-h-screen flex flex-col">
      <header>
        <nav
          ...
          className="flex justify-between items-center bg-ink-black-800 px-5 py-5 shadow shadow-ink-black-950"
        >
          ...
          <ul>
            <li className="text-ink-black-200 flex gap-2">
              <a href="/auth/login" className="font-bold" aria-label="Fazer login na sua conta">
                Meus Discos
              </a>
